/** Authoritative ILM page content — keep wording as supplied. */

export const homeContent = {
  title: 'Islamic League of Murabbiyūn',
  tagline: 'Knowledge. Clarity. Cultivation.',
  supporting: 'Making beneficial Islamic knowledge accessible to Muslims in America.',
  body: [
  ...
  closing: 'Making Islam clear. Making knowledge accessible. Cultivating Muslims.',
  shortHand: [
    'Islamic League of Murabbiyūn',
    'Making Islam clear. Making knowledge accessible. Cultivating Muslims.',
    'Reliable Islamic education for Muslims in America, rooted in the Qur’an, Sunnah, and the methodology of Ahlus-Sunnah wa-l-Jamāʿah.',
  ],
} as const;
...
export const aboutContent = {
  ...
  principles: [
    {
      title: 'Sincerity',
      body: 'Seeking the pleasure of Allah and the benefit of the Muslim community.',
    },
    {
      title: 'Sound scholarship',
      body: 'Building educational material upon reliable sources and sound principles.',
    },
    {
      title: 'Clarity',
      body: 'Explaining Islamic guidance in language that ordinary Muslims can understand.',
    },
    {
      title: 'Practical relevance',
      body: "Prioritizing matters that directly affect Muslims' everyday lives.",
    },
    {
      title: 'Intellectual honesty',
      body: 'Distinguishing established matters from areas of legitimate scholarly disagreement.',
    },
    {
      title: 'Respect for scholarship',
      body: 'Recognizing the established Islamic scholarly tradition and avoiding casual or uninformed judgments.',
    },
    {
      title: 'Responsibility',
      body: 'Publishing only material that the author is prepared to stand behind as a representation of his research.',
    },
    {
      title: 'Cultivation',
      body: 'Seeking not merely to inform Muslims, but to cultivate sound understanding, worship, character, and practice.',
    },
    {
      title: 'Service',
      body: 'Making beneficial Islamic knowledge accessible to Muslims throughout the United States.',
    },
  ],
  closing:
    'This standard will be seen and easily attested to by academics and laymen, and it is this standard that will be the means of achieving the primary goal of this website inshā’llah.',
  ...
  founderParagraphs: [
    ...
    'It is not unknown to anyone given ears by which they hear, eyes by which they see, and a sound heart by which they comprehend, that the challenges of the Muslims in the west (generally) and in the United States (specifically) are various and multifaceted. These challenges require clear insight and understanding of the revelation revealed from Allah to our Prophet Muhammad -sallahu alaihi wa sallam- in order to identify, assess, and arrive at the best means to overcome these challenges.The complexities of these challenges are not insurmountable, the remedy to them is not unknown, and the means to overcome them are obtainable. Returning to the guidance of revelation is the first step in addressing the challenges we’re faced with today as Allah has made explicitly clear all things the son of Adam requires to be successful in this life and the Hereafter, regardless of the place and time one may be.',
    'Allah says:',
    ...
    'Imam ibn Jarīr at-Tabari said in his exegesis to the Quran: “This Quran is sent down to you O’ Muhammad of all of that which humanity stands in need of from awareness of the lawful and unlawful, reward and punishment, etc.”',
    'Imam ibn Kathir said: “Undoubtedly, the Quran is inclusive of all beneficial knowledge from past narratives and future knowledge. Likewise, every lawful and unlawful matter along with whatever humanity stands in need of as it pertains to their worldly and religious related affairs, and their livelihood and ultimate (eternal) abode.”',
