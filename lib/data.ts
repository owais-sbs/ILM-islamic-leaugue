...
export const articles: Article[] = [
  ...
  { id: '15', slug: 'the-adab-of-seeking-knowledge', title: 'The adab of seeking knowledge', excerpt: 'Before the pen touches the page and before the ear opens to the teacher, there is a preparation of the heart that the tradition has always demanded.', body: `<p>The Islamic tradition has always understood that knowledge is not merely a cognitive acquisition — it is a moral and spiritual undertaking. Before the pen touches the page and before the ear opens to the teacher, there is a preparation of the heart that the tradition has always demanded.</p><h2>What is adab?</h2><p>The word <em>adab</em> in Arabic carries a richness that resists simple translation. It encompasses manners, refinement, and a right orientation toward what is noble and true. In the context of knowledge, adab refers to the inner and outer comportment of the one who seeks to learn.</p><blockquote>Imam Mālik was asked about knowledge. He said: "Begin with adab before knowledge."</blockquote><p>This is a remarkable statement. It implies that without the right internal orientation, knowledge itself can become a source of harm — inflating the ego, hardening the heart, or becoming a tool of argumentation rather than a path to God.</p><h2>The outer dimensions of adab</h2><p>Outwardly, adab in learning includes punctuality, stillness, attentiveness, and respect for the teacher and the gathered community. These are not arbitrary rules — they create the conditions in which learning can genuinely take root.</p><h2>The inner dimensions</h2><p>Inwardly, adab requires sincerity of intention, humility before what one does not yet know, and a genuine openness to being changed by what one learns. The scholar who sits with armour already on — ready to deflect whatever challenges his existing views — has closed the very door that knowledge must enter.</p><p class="footnote"><sup>1</sup> This essay draws on the classical works on adab al-talib, including Ibn Jamaah's Tadhkirat al-Sami and al-Khatib al-Baghdadi's al-Faqih wal-Mutafaqqih.</p>`, category: 'Character & Practice', tags: ['knowledge', 'intention'], authorId: 'a2', authorName: 'Dr. Maryam Khalid', authorAvatar: IMG.scholar4, status: 'published', featuredImage: IMG.reading, publishedAt: '2024-09-01', updatedAt: '2024-09-01', readTime: '10 min read', views: 420 },
