...
function SearchInner() {
  ...
  return (
    <section className="mx-auto max-w-[1100px] px-4 py-12 sm:px-6 sm:py-16">
...
export default function SearchPage() {
  return (
    <main className="min-h-screen pt-28">
      ...
      <Suspense fallback={<div className="px-4 py-16 text-ilm-navy/40 sm:px-6">Loading search…</div>}>
        <SearchInner />
      </Suspense>
      <SiteFooter />
    </main>
