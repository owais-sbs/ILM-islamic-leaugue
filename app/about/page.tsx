  ...
  return (
    <main className="flex min-h-[100svh] flex-col overflow-hidden pt-28">
      ...
      <div className="flex-1">
        <section className="relative mx-auto max-w-[1100px] px-4 pb-10 pt-10 sm:px-6 sm:pt-12 lg:px-8">
        ...
        <section className="mx-auto grid max-w-[1100px] gap-6 px-4 py-8 sm:gap-10 sm:px-6 sm:py-10 lg:grid-cols-2 lg:px-8">
          <ScrollReveal from="left">
            <div className="rounded-[28px] border border-ilm-navy/8 bg-white p-6 shadow-[0_12px_40px_rgba(11,17,82,0.05)] sm:p-8">
          ...
          <ScrollReveal from="right" delay={0.08}>
            <div className="rounded-[28px] border border-ilm-navy/8 bg-ilm-navy p-6 text-white shadow-[0_12px_40px_rgba(11,17,82,0.12)] sm:p-8">
        ...
        <section className="mx-auto max-w-[1100px] px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
